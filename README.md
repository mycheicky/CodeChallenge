...
We simulate the value of asset as done for pricing the EUropean option but we simulate the value of asset every day. Thus in case the value of asset breaches up 
or down the barrier with respect of the option type and barrier type we add up at the maturity the option payoff. Afterwards, the barrier option price is given 
